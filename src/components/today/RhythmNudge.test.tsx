...
describe('RhythmNudge', () => {
  ...
  it('shows the plan-the-week nudge when due and fires onPlan', async () => {
    const onPlan = vi.fn()
    const { user } = render(<RhythmNudge due={{ kind: 'week', token: 'wk-1' }} onPlan={onPlan} />)
