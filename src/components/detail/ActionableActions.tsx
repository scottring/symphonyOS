    ...
    <div className="border-b border-neutral-100">
      ...
      <div className="flex items-center gap-2 p-4">
        ...
        <div className="relative" ref={moreMenuRef}>
          ...
          {showMoreMenu && (
            <div className="absolute bottom-full right-0 mb-1 w-40 bg-white rounded-lg shadow-lg border border-neutral-200 py-1 z-50">
              <button
                onClick={() => {
                  setShowMoreMenu(false)
              ...
              {onHideEvent && (
                <>
                  ...
                  <button
                    onClick={() => {
                      setShowMoreMenu(false)
                      handleAction('hide', onHideEvent)
                    }}
                    className="w-full px-4 py-2 text-sm text-left text-red-600 hover:bg-red-50 flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.05 6.05m3.828 3.828l4.242 4.242m0 0L17.95 17.95M15 12a3 3 0 00-3-3" />
                    </svg>
                    Hide this recurring event
                  </button>
                </>
              )}
            </div>
