...
export function WallV2GlanceCard({ card }: Props) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl bg-white/80 px-3.5 py-3 border border-stone-200/70 shadow-[0_1px_2px_rgba(0,0,0,0.02)] min-w-0">
      <div
      ...
      <div className="min-w-0 leading-tight">
        ...
        {card.secondary && (
          <div className="text-[0.78rem] text-stone-500 truncate">
            {card.secondary}
          </div>
        )}
      </div>
