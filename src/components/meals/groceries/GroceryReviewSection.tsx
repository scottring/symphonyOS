...
interface Props {
  ...
  /** Fired after a successful send. Parent updates `lastSendAt` and refreshes. */
  onSent: () => void
}
...
/** Inline grocery review — same content as SendToGroceriesModal, but rendered
 *  inside the unified ritual page rather than as a modal. The Send-to-Reminders
 *  CTA stays as the primary action at the bottom. */
export function GroceryReviewSection({ consolidated, groceriesListId, stores, currentItemTexts, recipesById, onSent }: Props) {
  ...
  return (
    <div className="rounded-3xl border border-neutral-200 bg-bg-elevated shadow-card overflow-hidden">
      <div className="px-6 pt-5 pb-3 border-b border-neutral-200">
        <div className="text-[0.7rem] font-bold uppercase tracking-[0.25em] text-neutral-500 mb-1">REVIEW & SEND</div>
