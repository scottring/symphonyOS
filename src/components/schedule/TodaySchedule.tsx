        ...
        {isMobile ? (
          <div className="flex items-center">
            ...
            <div className="flex items-center gap-1 pr-3">
              {/* This week — compact in header (Inbox lives in sidebar) */}
          ...
          <>
            ...
            <div className="flex items-center gap-4 pt-5 border-t border-neutral-200/60">
              ...
              {/* This week — inline in stats row (Inbox lives in sidebar) */}
              {isToday && onUpdateTask && (
                <>
                  <StagingFloat
                    weekTasks={weekTasks}
              ...
              {/* Symphony AI chat button */}
              {onOpenChat && (
                <button
                  onClick={onOpenChat}
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-sm text-primary-600 hover:text-primary-700 hover:bg-primary-50 transition-all duration-200"
                  title="Ask Symphony AI"
                >
